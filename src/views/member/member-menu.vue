      ...
      <div class="slidebar">
        ...
        <ul class="slide_item">
          <li class="item">
            ...
            <ul>
              <li>
                <a @click="toOrder" :class="{on: current==='order'}">我的订单</a>
                <a  @click="toReceive" :class="{on: current==='receive'}">收货地址</a>
              </li>
            </ul>
          </li>
          <li class="item">
            ...
            <ul>
              <li>
                <a @click="toUserinfo" :class="{on: current==='userinfo'}">用户信息</a>
                <a @click="toCollection" :class="{on: current==='collenction'}">我的收藏</a>
                <a @click="toMessage" :class="{on: current==='message'}">我的留言</a>
              </li>
            </ul>
          </li>
        </ul>
