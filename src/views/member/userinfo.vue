              ...
              <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                ...
                <tr>
                  ...
                  <td width="72%" align="left" bgcolor="#FFFFFF">
                    <input name="email" type="text" placeholder="" size="25" class="inputBg" v-model="userInfo.name"></td>
                </tr>
                <tr>
...
<script>
import { getUserDetails, updateUserInfo } from '../../api/api'
  ...
  methods: {
    ...
    getUserInfo () { // 请求用户的信息
      ...
      getUserDetails().then(response => {
        console.log(response.data, 'wwwwwwwwwwwwwwww')
