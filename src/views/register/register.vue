          ...
          <div class="tab-form">
            <form id="mobile_register_form" autocomplete="off">
              ...
              <div class="form-group marb8">
                <label>手&nbsp;机&nbsp;号</label>
                <input v-model="mobile" id="jsRegMobile" name="account" placeholder="请输入您的手机号码">
              </div>
              ...
              <div class="clearfix">
                ...
                <input class="verify-code-btn sendcode" type="button" id="jsSendCode" :value="getMassageText" @click="sendMessage">
              </div>
              ...
              <input class="btn btn-green" id="jsMobileRegBtn" type="button" @click="isRegister" value="注册并登录">
            </form>
          </div>
